...
// ✅ YOUR CORRECT CREDENTIALS - MATCHES EMAILJS DASHBOARD!
const SERVICE_ID = 'service_uzhwabh';
const TEMPLATE_ID = 'template_96l2gmk';     // ← 'l' not '1'!
const PUBLIC_KEY = 'cJY-56CPf0N_ThgWF';     // ← 'F' uppercase!
            ...
            <div>
              <div className={`p-6 rounded-2xl ${
                ...
                <div className="space-y-4 mb-8">
                  <div className={`flex items-center space-x-4 p-3 rounded-xl transition-all duration-300 hover:scale-[1.02] ${
                    theme === 'dark' ? 'bg-gray-800/50 hover:bg-gray-700/50' : 'bg-gray-100/50 hover:bg-gray-200/50'
                  }`}>
                ...
                {socialLinks.map(link => (
                  <a 
                    ...
                    className={`w-10 h-10 flex items-center justify-center rounded-full transition-all duration-300 hover:scale-110
                             ${
                               theme === 'dark'
                                 ? 'bg-gray-800 hover:bg-gradient-to-r from-[#009A44] via-[#FED100] to-[#E4002B] text-gray-400 hover:text-white'
                                 : 'bg-gray-100 hover:bg-gradient-to-r from-[#009A44] via-[#FED100] to-[#E4002B] text-gray-600 hover:text-white'
                             }`}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className={`w-full px-4 py-3 rounded-xl transition-all duration-300 focus:scale-[1.01] ${
                        theme === 'dark' 
                          ? 'bg-gray-800/80 border-gray-700 focus:ring-2 focus:ring-[#009A44]' 
                          : 'bg-white/80 border-gray-200 focus:ring-2 focus:ring-[#009A44]'
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl transition-all duration-300 focus:scale-[1.01] ${
                        theme === 'dark' 
                          ? 'bg-gray-800/80 border-gray-700 focus:ring-2 focus:ring-[#FED100]' 
                          : 'bg-white/80 border-gray-200 focus:ring-2 focus:ring-[#FED100]'
                      } border focus:outline-none ${
                        theme === 'dark' ? 'text-white' : 'text-gray-900'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl transition-all duration-300 focus:scale-[1.01] ${
                        theme === 'dark' 
                          ? 'bg-gray-800/80 border-gray-700 focus:ring-2 focus:ring-[#E4002B]' 
                          : 'bg-white/80 border-gray-200 focus:ring-2 focus:ring-[#E4002B]'
                      } border focus:outline-none ${
                        theme === 'dark' ? 'text-white' : 'text-gray-900'
                      }`}
                  ...
                  >
                    ...
                    <span className="absolute inset-0 bg-gradient-to-r from-[#009A44] via-[#FED100] to-[#E4002B] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg" />
                  </button>

                  {submitStatus === 'success' && (
                    <div className="p-4 bg-green-900/20 border border-green-700 rounded-xl text-green-400 text-sm animate-fade-in">
                      ✅ Your message has been sent successfully! I'll get back to you soon.
                    </div>
                  )}

                  {submitStatus === 'error' && (
                    <div className="p-4 bg-red-900/20 border border-red-700 rounded-xl text-red-400 text-sm animate-fade-in">
