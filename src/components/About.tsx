    ...
    <EthiopianAmbientBackground>
      <section id="about" className="py-12 sm:py-20 relative overflow-hidden">
        ...
        <div className="section-container relative z-10 px-4 sm:px-6 lg:px-8">
          <h2 className={`section-title text-2xl sm:text-3xl md:text-4xl ${theme === 'dark' ? 'text-white' : 'text-gray-900'} text-center sm:text-left`}>
            About Me
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mt-8 md:mt-12 lg:mt-16">
            ...
            <div className="space-y-4 md:space-y-6">
              {/* ✅ All bio cards now full width and responsive */}
              <div className={`p-4 sm:p-5 md:p-6 rounded-2xl ${
                theme === 'dark' 
                  ? 'bg-gray-900/60 backdrop-blur-md border border-gray-800' 
                  : 'bg-white/60 backdrop-blur-md border border-gray-200'
              }`}>
                <p className={`text-sm sm:text-base ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} leading-relaxed`}>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4 pt-4">
                <div className={`text-center p-3 sm:p-4 rounded-xl ${
                  ...
                  <p className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#009A44] to-[#FED100] bg-clip-text text-transparent">2+</p>
                  <p className={`text-[10px] sm:text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Projects</p>
                </div>
                <div className={`text-center p-3 sm:p-4 rounded-xl ${
                  theme === 'dark' ? 'bg-gray-800/80 backdrop-blur-sm border border-gray-700' : 'bg-white/80 backdrop-blur-sm border border-gray-200'
                } transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/20`}>
                  <p className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#FED100] to-[#E4002B] bg-clip-text text-transparent">Coming</p>
                  <p className={`text-[10px] sm:text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Music Videos</p>
                </div>
                <div className={`text-center p-3 sm:p-4 rounded-xl ${
                  theme === 'dark' ? 'bg-gray-800/80 backdrop-blur-sm border border-gray-700' : 'bg-white/80 backdrop-blur-sm border border-gray-200'
                } transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-500/20`}>
                  <p className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#E4002B] to-[#009A44] bg-clip-text text-transparent">2018</p>
                  <p className={`text-[10px] sm:text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Graduated</p>
                </div>
              </div>

              {/* ✅ CV Download Card - Mobile responsive */}
              <div className={`p-4 sm:p-6 rounded-2xl ${
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-center gap-3 sm:gap-4">
                  <div className={`p-3 rounded-full ${
                    ...
                    <FileText size={24} className="text-[#009A44]" />
                  </div>
                  ...
                  <a
                    ...
                    className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 relative overflow-hidden group w-full sm:w-auto ${
                      theme === 'dark'
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              } text-center sm:text-left`}>My Skills</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                ...
                {/* Development Skills */}
                <div
                  className={`p-4 sm:p-5 md:p-6 space-y-3 md:space-y-4 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-blue-500/10 border ${
                ...
                >
                  ...
                  <ul className={`space-y-1.5 pl-4 relative z-10 text-sm sm:text-base ${theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
                ...
                <div
                  className={`p-4 sm:p-5 md:p-6 space-y-3 md:space-y-4 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-teal-500/10 border ${
                    theme === 'dark' ? 'bg-gray-800/80 backdrop-blur-sm border-gray-700' : 'bg-white/80 backdrop-blur-sm border-gray-200'
                  } transition-all duration-500 hover:scale-[1.02] group`}
                >
                ...
                {/* Music Skills - Full width */}
                <div
                  className={`p-4 sm:p-5 md:p-6 space-y-3 md:space-y-4 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-yellow-500/10 border ${
                    theme === 'dark' ? 'bg-gray-800/80 backdrop-blur-sm border-gray-700' : 'bg-white/80 backdrop-blur-sm border-gray-200'
                  } transition-all duration-500 hover:scale-[1.02] group col-span-1 sm:col-span-2`}
                >
                  ...
                  <ul className={`grid grid-cols-2 gap-1.5 pl-4 relative z-10 text-sm sm:text-base ${theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
                    <li>Songwriting</li>
